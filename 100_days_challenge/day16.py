...
4. The case clause consists of a pattern to be matched to the variable, a condition to be evaluated if the pattern matches, and a set of statements to be executed if the pattern matches.
...
''' In python we do not need break statements as in JAVA/C++ by default in python if there a case matched then it will exit the match loop'''
